...
<meta name="description" content="EtherCore Wallet is a free, open-source, client-side interface for generating EtherCore wallets & more. Interact with the EtherCore blockchain easily & securely.">
<meta property="og:description"  content="Free, open-source, client-side EtherCore wallet. Enabling you to interact with the blockchain easily & securely.">
<meta name="twitter:description" content="Free, open-source, client-side EtherCore wallet. Enabling you to interact with the blockchain easily & securely.">
...
<meta name="apple-mobile-web-app-title" content="MyEtherWallet &middot; Your Key to EtherCore">
...
<meta name="twitter:site" content="@ethercore">
<meta name="twitter:creator" content="@ethercore">
...
"sameAs" : [
  ...
  "https://medium.com/@ethercore",
  "https://github.com/ethercoreorg/ethcorewallet",
  "https://github.com/ethcoreorg"
]
}
</script>
</head>
  ...
  <section class="container">
    @@if (site === 'mew' ) {
      <a class="brand" href="/" aria-label="Go to homepage">
        <img src="images/EtherCorewallet-logo.svg" height="64px" width="245px" alt="EtherCore Wallet" />
