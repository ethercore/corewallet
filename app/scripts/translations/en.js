...
ONBOARD_blockchain_content__5   :  'When you see your balance on MyEtherWallet.com or view your transactions on [explorer.ethercore.io](https://explorer.ethercore.io), you are seeing data on the blockchain, not in our personal systems.',
...
PARITY_AlreadyImported          :  "(parity-01) A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [explorer.etherocre.io](https://explorer.etherocre.io) & wait 10 minutes before attempting to send again. [Learn More.](https://kb.myetherwallet.com/transactions/transactions-not-showing-or-pending.html)",
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different EtherCore node (e.g. `EtherCore (etherocre.io)`) and check again.',
...
HELP_16_Desc_1                  :  'You can use a blockchain explorer like [explorer.etherocre.io](https://explorer.etherocre.io). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://explorer.etherocre.io/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on explorer.etherocre.io',
HELP_16_Title                   :  '16) How do I check the balance of my account?',
HELP_17_Desc_1                  :  'This is most likely due to the fact that you are behind a firewall. The API that we use to get the balance and convert said balance is often blocked by firewalls for whatever reason. You will still be able to send transactions, you just need to use a different method to see said balance, like explorer.etherocre.io',
...
HELP_Sec_Desc_4                 :  'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://wallet.etherocre.io](https://wallet.etherocre.io).',
