...
ONBOARD_blockchain_content__5   :  'When you see your balance on MyEtherWallet.com or view your transactions on [explorer.ethercore.org](https://explorer.ethercore.org), you are seeing data on the blockchain, not in our personal systems.',
...
PARITY_AlreadyImported          :  "(parity-01) A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [explorer.ethercore.org](https://explorer.ethercore.org) & wait 10 minutes before attempting to send again. [Learn More.](https://kb.myetherwallet.com/transactions/transactions-not-showing-or-pending.html)",
...
GAS_PRICE_Desc                  :  'Gas Price is the amount you pay per unit of gas. `TX fee = gas price * gas limit` & is paid to miners for including your TX in a block. Higher the gas price = faster transaction, but more expensive. Default is `1 GWEI`.',
...
SUCCESS_3                       :  'Your TX has been broadcast to the network',
...
tx_notFound_4                   :  'Please use the dropdown in the top-right & select a different EtherCore node (e.g. `EtherCore (ethercore.org)`) and check again.',
...
HELP_16_Desc_1                  :  'You can use a blockchain explorer like [explorer.ethercore.org](https://explorer.ethercore.org). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://explorer.ethercore.org/addr/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on explorer.ethercore.org',
HELP_16_Title                   :  '16) How do I check the balance of my account?',
HELP_17_Desc_1                  :  'This is most likely due to the fact that you are behind a firewall. The API that we use to get the balance and convert said balance is often blocked by firewalls for whatever reason. You will still be able to send transactions, you just need to use a different method to see said balance, like explorer.ethercore.org',
